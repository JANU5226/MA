...
try:
	prox= requests.get('https://github.com/JANU5226/JANU5226/blob/main/AM.TXT').text
...
android_models=[]
try:
	xx = requests.get('https://github.com/JANU5226/JANU5226/blob/main/AM.TXT').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://github.com/JANU5226/JANU5226/blob/main/AM.TXT').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
